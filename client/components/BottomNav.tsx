          ...
          {nav.map((item) => {
            ...
            return (
              <button
                ...
                className="relative flex min-h-[52px] min-w-[56px] flex-1 flex-col items-center justify-center px-1 py-1.5 text-[10px] font-semibold"
              >
                {active && (
                  <motion.div
                ...
                <motion.span
                  ...
                  className={`relative z-10 flex h-8 w-full items-center justify-center text-[16px] leading-none ${
