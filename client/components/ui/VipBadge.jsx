...
export default function VipBadge({ level = 0, className = "", showGlow = false }) {
  ...
  return (
    <span
      title={tip}
      className={`group relative inline-flex cursor-help items-center rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 px-2.5 py-1 text-[10px] font-black uppercase tracking-wide text-gray-900 ${
        showGlow ? "animate-pulse shadow-[0_0_24px_rgba(251,191,36,0.55)] ring-2 ring-amber-300/35" : "shadow-[0_0_20px_rgba(251,191,36,0.45)]"
